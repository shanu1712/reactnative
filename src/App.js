...
function App() {
  ...
  return (
    <View style={styles.app}>
      ...
      <Text>Enter Your values: {state}</Text>
      {/*  code to write the values entered through textinput */}
      <TextInput
      ...
      <Button
        ...
        onPress={() => setState("")}
      />
      {/*  value that's why to match with the empty state value on pressing the button */}
    </View>
  );
}
